...
static const char *const autostart[] = {
	"slstatus", NULL,
    "compton", NULL,
    "feh", "--bg-scale", "/home/tedewaard/Pictures/railroad.jpg", NULL,
    "flameshot", NULL,
	NULL /* terminate */
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_mauve, "-sb", col_mauve, "-sf", col_gray1, NULL };
